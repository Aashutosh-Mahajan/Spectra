...
def generate_markdown_report(
    ...
    Args:
        ...
        orchestrator_summary: Optional summary generated by the OrchestratorAgent
    ...
    if orchestrator_summary and "health_score" in orchestrator_summary:
        risk_score = orchestrator_summary["health_score"]
    elif findings:
    ...
    # Header
    lines.append("# 🔍 SPECTRA Audit Report\n")
    ...
    # Footer
    lines.append("---\n")
    lines.append("*Report generated by SPECTRA*")
